    ...
    const slides: Slide[] = [
        {
            id: 0,
            title: "NOAH Protocol",
            subtitle: "The Privacy Layer for Identity",
            ...
            content: (
                <div style={{ textAlign: 'center' }}>
                    ...
                    <div className="glass" style={{ display: 'inline-flex', padding: '1rem 2rem', borderRadius: '3rem', gap: '2rem', alignItems: 'center' }}>
                        ...
                        <span style={{ fontSize: '0.875rem', color: 'var(--text-dim)' }}>Built with FHE</span>
                    </div>
                </div>
            )
        },
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, display: 'grid', gap: '1.5rem' }}>
                        <li style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                            ...
                            <div>
                                ...
                                <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>FHEVM ensures identity grants are settled with full on-chain privacy.</p>
                            </div>
                        </li>
                        <li style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                            <div style={{ minWidth: '24px', height: '24px', borderRadius: '50%', background: 'var(--primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '0.75rem' }}>✓</div>
                        ...
                        <li style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                            ...
                            <div>
                                ...
                                <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>Privacy-preserving RWAs needing confidential verification layers.</p>
                            </div>
                        </li>
                    </ul>
                </div>
